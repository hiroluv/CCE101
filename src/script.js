    ...
    <React.Fragment>
      <nav id="navbar">
        <div className="nav-wrapper">
          <p className="brand">
            <strong> Jules</strong><strong> Henri</strong><strong> Reyes</strong>
          </p>
          <a
  ...
  return (
    <header id="welcome-section">
      ...
      <div className="container">
        <h1>
          <span className="line">Bilat</span>
          <span className="line">graphic design</span>
          <span className="line">
            <span className="color">&</span> Oten.
          </span>
        </h1>
      ...
      <di className="wrapper">
        <article>
          ...
          <div className="desc full">
            <h4 className="subtitle">My name is Jules Henri Reyes.</h4>
            <p>
              I am a first year BSIT Student from University of Mindanao in beautiful City of the Philippines,
              Davao.
            </p>
            <p>
